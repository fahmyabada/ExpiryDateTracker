...
class UpdateStatusExpiryUseCaseTest{
    private lateinit var fakeItemsRepository: FakeItemsRepository
    private lateinit var updateStatusExpiryUseCase: UpdateStatusExpiryUseCase
    ...
    fun setup() {
        ...
        updateStatusExpiryUseCase = UpdateStatusExpiryUseCase(fakeItemsRepository)
    }
    ...
    fun testExecute() = runBlocking {
        ...
        updateStatusExpiryUseCase.execute(1)
